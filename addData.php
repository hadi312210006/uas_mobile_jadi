...
<body background="img/bg/walfafer_isalami.jpg">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Siswa SMK pelita_bangsa</a>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="Teknik Jaringan Akses">Teknik Informatika</option>
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         Pembuat:
                         1. Hadi Putra (312210006)
                         2. asep saepuloh (312210037)
                         3. arya saepul hakim (312210608)
                         4. rizky aji nugraha (312210609)
                    </p>
               </div>
          </div>
     </div>
